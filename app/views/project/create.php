...
<div class="bg-gradient-to-r from-blue-100 to-blue-300 min-h-screen flex items-center justify-center py-10">
    <div class="bg-white shadow-2xl rounded-2xl p-10 w-full max-w-4xl mx-auto">
        <h1 class="text-3xl font-bold text-center text-blue-800 mb-8">Add Project</h1>

        <form action="<?= $base_url ?>/project/create" method="POST" class="grid grid-cols-1 gap-6">
            <!-- Project Name -->
            <div>
            ...
            <div class="flex justify-between items-center mt-4">
                ...
                <button type="submit" class="bg-blue-600 text-white px-6 py-2 rounded-lg font-bold hover:bg-blue-700 transition">Add</button>
            </div>
        </form>
    </div>
</div>
